...
skel.init({
	reset: 'full',
	breakpoints: {
		global:		{ range: '*', href: '/reconnect/css/style.css', containers: 1400, grid: { gutters: 50 } },
		wide:		{ range: '-1680', href: '/reconnect/css/style-wide.css', containers: 1200, grid: { gutters: 40 } },
		normal:		{ range: '-1296', href: '/reconnect/css/style-normal.css', containers: 960, lockViewport: true },
		narrow:		{ range: '-980', href: '/reconnect/css/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
