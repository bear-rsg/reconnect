...
skel.init({
	...
	breakpoints: {
		...
		wide:		{ range: '-2400', href: '/reconnect/css/style-wide.css', containers: 1200, grid: { gutters: 40 } },
		normal:		{ range: '-1280', href: '/reconnect/css/style-normal.css', containers: 960, lockViewport: true },
		narrow:		{ range: '-1005', href: '/reconnect/css/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
