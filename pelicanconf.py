...
DIRECT_TEMPLATES = ['index', 'updates', 'resources', 'team', 'projects_gallery', 'categories', 'tags', 'page_with_banner']
PAGINATED_DIRECT_TEMPLATES = ['index', 'updates', 'resources', 'team', 'projects_gallery', 'categories', 'tags', 'page_with_banner']
